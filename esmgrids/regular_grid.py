...
class RegularGrid(BaseGrid):
    ...
    def __init__(self, num_lons, num_lats, mask_t=None, levels=[0], description=""):
        ...
        super(RegularGrid, self).__init__(x_t=lons, y_t=lats, mask_t=mask_t, levels=levels, description=description)
