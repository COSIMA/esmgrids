...
class OasisGrid(BaseGrid):
    ...
    def write_grids(self, grids_filename):
        ...
        for cell in self.cells:
            ...
            tmp.title = "{} grid {}-cell latitude.".format(self.model_grid.full_name, cell.upper())
            tmp[:] = y[:]
            ...
            tmp.title = "{} grid {}-cell longitude.".format(self.model_grid.full_name, cell.upper())
            tmp[:] = x[:]
            ...
            try:
                ...
                if str(e) == "NetCDF: String match to name in use":
                    ...
                    raise e
            tmp.units = "degrees_north"
            tmp.title = "{} grid {}-cell corner latitude".format(self.model_grid.full_name, cell.upper())
            tmp[:] = clat[:]
            ...
            try:
                ...
                if str(e) == "NetCDF: String match to name in use":
                    ...
                    raise e
            tmp.units = "degrees_east"
            tmp.title = "{} grid {}-cell corner longitude".format(self.model_grid.full_name, cell.upper())
            tmp[:] = clon[:]
        ...
        for cell in self.cells:
            ...
            try:
                ...
                if str(e) == "NetCDF: String match to name in use":
                    ...
                    raise e
            tmp.units = "m^2"
            tmp.title = "{} grid {}-cell area.".format(self.model_grid.full_name, cell.upper())
            tmp[:] = area[:]
        ...
        for cell in self.cells:
            ...
            try:
                ...
                if str(e) == "NetCDF: String match to name in use":
                    ...
                    raise e
            tmp.units = "0/1:o/l"
            tmp.title = "{} grid {}-cell land-sea mask.".format(self.model_grid.full_name, cell.upper())
